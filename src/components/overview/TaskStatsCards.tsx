  ...
  const cards: CardConfig[] = [
    {
      ...
      value: stats.total,
      total: stats.total,
      icon: <Assignment sx={{ fontSize: 20, color: "#605E5C" }} />,
      accent: "#605E5C",
      accentLight: "#F3F2F1",
    ...
    },
    {
      ...
      value: stats.new,
      total: stats.total,
      icon: <FiberNew sx={{ fontSize: 20, color: "#0078D4" }} />,
      accent: "#0078D4",
      accentLight: "#deeffe",
    ...
    },
    {
      ...
      value: stats.active,
      total: stats.total,
      icon: <PlayCircleOutline sx={{ fontSize: 20, color: "#8764B8" }} />,
      accent: "#8764B8",
      accentLight: "#ede7f6",
    ...
    },
    {
      ...
      value: stats.removed,
      total: stats.total,
      icon: <RemoveCircleOutline sx={{ fontSize: 20, color: "#D13438" }} />,
      accent: "#D13438",
      accentLight: "#fde7e8",
